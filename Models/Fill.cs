...
namespace Models
{
    public class Fill
    {
        ...
        public int salary_sum { get; set; }
        public int demand_salaray_sum { get; set; }
        public int paid_salary_sum { get; set; }
        ...
        public int Bouns_sum { get; set; }
        public int Sale_sum { get; set; }
        public int Deduct_sum { get; set; }
