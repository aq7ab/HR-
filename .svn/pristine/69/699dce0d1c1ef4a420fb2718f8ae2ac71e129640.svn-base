...
namespace WebApplication1.Controllers
{
    public class CilentController : Controller
    {
        ...
        public ActionResult ThirdKindInsert()
        {
            //ViewBag.s = await cf.FirstSelectAsync();
            return View();
        }
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<ActionResult> ThirdKindXia()
        {
            IEnumerable cs = await tk.GetFindAsync();
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<ActionResult> CPC(FenYe<ConfigPublicChar> fenye,string tj)
        {
            fenye = await cp.CPCSelectAsync(fenye,tj);
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult SalaryGrantMode()
        {
            return View();
        }
